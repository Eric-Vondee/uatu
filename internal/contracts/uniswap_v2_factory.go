...
func (_V2Factory *V2FactoryCaller) INITCODEPAIRHASH(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _V2Factory.contract.Call(opts, &out, "INIT_CODE_PAIR_HASH")
...
//
// Solidity: function INIT_CODE_PAIR_HASH() view returns(bytes32)
func (_V2Factory *V2FactorySession) INITCODEPAIRHASH() ([32]byte, error) {
	return _V2Factory.Contract.INITCODEPAIRHASH(&_V2Factory.CallOpts)
}

// INITCODEPAIRHASH is a free data retrieval call binding the contract method 0x5855a25a.
//
// Solidity: function INIT_CODE_PAIR_HASH() view returns(bytes32)
func (_V2Factory *V2FactoryCallerSession) INITCODEPAIRHASH() ([32]byte, error) {
	return _V2Factory.Contract.INITCODEPAIRHASH(&_V2Factory.CallOpts)
}
